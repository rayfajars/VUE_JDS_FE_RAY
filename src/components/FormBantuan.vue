              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input
                    ...
                    type="number"
                    name="kartu_keluarga"
                    placeholder="Masukan Nomor Kartu Keluarga anda disini"
                    required
                    v-model="no_kk"
                  />
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input
                    ...
                    type="number"
                    name="umur"
                    placeholder="Masukan Umur anda disini"
                    required
                    min="25"
                    v-model="umur"
                  />
                ...
                <div class="col-lg-9">
                  ...
                  >
                    ...
                    <option value="Kehilangan pekerjaan"
                      >Kehilangan pekerjaan</option
                    >
                    <option value="Kepala keluarga terdampak atau korban Covid"
                      >Kepala keluarga terdampak atau korban Covid</option
                    >
                    <option
                      value="Tergolong fakir/miskin semenjak sebelum Covid"
                      >Tergolong fakir/miskin semenjak sebelum Covid</option
                    >
              ...
              <div class="form-group row" v-if="alasan == 'Lainnya'">
                ...
                <div class="col-lg-9">
                  <input
                    ...
                    type="text"
                    name="lainnya"
                    placeholder="Masukan alasan lainnya  disini"
                    required
